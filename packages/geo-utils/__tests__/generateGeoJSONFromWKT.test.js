...
describe('generateGeoJSONFromWKT', () => {
    ...
    test('generates GeoJSON from WKT data', async () => {
        ...
        const geoUtils = new src_1.GeoUtils('http://localhost:3000');
        const data = [
            {
                name: 'Central Park',
                geometry: 'POLYGON((-73.9731 40.7644, -73.9731 40.8004, -73.9581 40.8004, -73.9581 40.7644, -73.9731 40.7644))',
            },
            {
                name: 'Times Square',
    ...
    test('handles validation errors', async () => {
        ...
        await expect(geoUtils.generateGeoJSONFromWKT(invalidData, 'geometry')).rejects.toThrow();
    });
});
