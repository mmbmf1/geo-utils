...
describe('generateGeoJSONFromPoints', () => {
    ...
    test('generates GeoJSON from coordinate data', async () => {
        ...
        const result = await geoUtils.generateGeoJSONFromPoints(data, 'lat', 'lng', ['name']);
    ...
    test('handles validation errors', async () => {
        ...
        await expect(geoUtils.generateGeoJSONFromPoints(invalidData, 'lat', 'lng')).rejects.toThrow();
    });
});
